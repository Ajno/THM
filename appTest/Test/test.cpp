...
void ControllerTest::humidityUpdate1()
{
    ...
    pOscillator->setFrequency(19*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum2 = pLcd->getScreen().text;
    pOscillator->setFrequency(45670*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum3 = pLcd->getScreen().text;
    pOscillator->setFrequency(9549*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum4 = pLcd->getScreen().text;
    pOscillator->setFrequency(21008*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum5 = pLcd->getScreen().text;
    pOscillator->setFrequency(1750*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum6 = pLcd->getScreen().text;
    pOscillator->setFrequency(61789*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum7 = pLcd->getScreen().text;
    pOscillator->setFrequency(84*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum8 = pLcd->getScreen().text;
    pOscillator->setFrequency(70*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum9 = pLcd->getScreen().text;
    pOscillator->setFrequency(15000*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum10 = pLcd->getScreen().text;
    pOscillator->setFrequency(5000*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
    screenHum11 = pLcd->getScreen().text;
    pOscillator->setFrequency(2500*cTimeoutSamplingPeriod/10);
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
...
void ControllerTest::lowBatteryWarning()
{
    ...
    pTimer->stop(TimerMock::cTimerMiliSec);
    controller();
    string screen1 = pLcd->getScreen().text;
    pTimer->stop(TimerMock::cTimerMiliSecX100);
    controller();
